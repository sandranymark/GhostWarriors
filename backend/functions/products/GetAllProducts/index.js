...
export const handler = middy(GetAllProducts).use(httpErrorHandler());

// Författare: Adréan
// Modifierad: Anton
// Edit by Sandra - lagt till  middy, httpErrorHandler och skapat ett valideringsSchema med JOI.
